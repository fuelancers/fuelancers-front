...
import Select, { components, MultiValue, PlaceholderProps, SingleValue } from 'react-select';
...
interface IProps {
    data: {
        ...
        fullWidth?: boolean;
        styleInput?: string;
        value: MultiValue<TypeListsSelect> | null;
        onSelect: (option: MultiValue<TypeListsSelect>) => void;
    };
...
export default function CustomMultiSelect({ data, children }: IProps) {
    const {
        label,
        name,
        options,
